...
async function main() {
    ...
    const frame = (now) => {
        ...
        if (vertexCount > 0) {
            ...
            // gl.drawArraysInstanced(gl.LINE_STRIP, 0, 10,vertexCount);
            gl.drawArraysInstanced(gl.POINTS, 0, 5,vertexCount);
